...
|阅读源码|完成时间|资料地址|心得|
|:----------|:----------|:----------|:----------|
|基于词表的分词程序friso|2017/07/18|Segmentation\friso-master|作者C功底深厚，实现了string、动态数组、双向链表、基于buckte的hash表等基础数据结构；精细的控制内存的使用；FMM和MMSEG算法代码清晰易懂，易于做二次开发，但数字英文、英文数字组合以及二次切分的逻辑复杂，以后有需要再仔细研究|
|200行Python代码实现感知机词性标注器|2017/07/24|LiHang\Ch02\AveragedPerceptronPython|结构化感知机、平均感知机的示例程序，理论参考Collins和邓知龙的论文|
