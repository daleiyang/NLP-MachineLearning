...
> 2. 通过代码理解了：1. 词性标注的特征抽取方法. 2.结构化平均感知机的学习算法是如何实现Collins的论文算法.
> 3. 通过代码理解了：1. 分词，命名实体识别采用的抽取特征的方法和词性标注抽取特征的方法大同小异。2. 代码是如何实现Collins论文中的算法的。3. 使用Backoff05的MSR训练、测试语料，经过5论训练，无正则化处理，F值在 0.9472, 存在的问题是L1,L2的学习率需要调整,模型剪裁还没实验 4.让人体会到python用很短的代码就能够完成复杂功能，但是训练起来很慢。5. 很想做一份C的实现，和清华分词比比效果，以后有时间再做吧.
