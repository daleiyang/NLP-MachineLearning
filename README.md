...
5. 我用一个月的时间，找材料、读论文、看代码、找到了最好的训练方法、结合适合的对齐方式、活用w2v的能力，使得句子相似度匹配的精确度有了大幅度提高。具体项目细节、实现方法，不便说。这里我记录一下学习的路径和心得，方便后来人。
   ...
   * <<word2vec 中的数学原理详解>> 中的讲解细致入微，，其中 4.1.2 节对 HS 的讲解精彩绝伦， 4.2.2 节对 skip-gram 的公式推导正确，但代码实现采用的是其他方法，然后 5.2 节对 skip-gram 的理解进行了修正。公式推导和代码实现一致度很高。
   *<<How to Generate a Good Word Embedding?>> 这篇论文对比了各种词向量生成的方法，并推荐了最佳选择，可以直接拿来用。
