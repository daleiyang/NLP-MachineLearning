...
|结构化平均感知机的分词器|2017/08/02|Segmentation\结构化平均感知机的分词器|使用Backoff05的MSR训练、测试语料，经过5论训练，无正则化处理，F值在 0.9472, 存在的问题是L1,L2的学习率需要调整,模型剪裁还没实验,这是一个很好的demo，让人体会到python用很短的代码就能够完成复杂功能，但是训练起来很慢。通过这个demo也理解了词性标注，分词，命名实体识别的通用方法，能够看出代码是如何实现Collins论文中的算法。|
